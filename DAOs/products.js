...
const schema = require('./mongodb/productsSchema.js')

class Products {

    async connect () {
        await mongoose.connect('mongodb+srv://Skaelet:backCoder@cluster0.t1jtlg8.mongodb.net/ecommerce?retryWrites=true&w=majority');
    }
